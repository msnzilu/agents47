    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_verification_token', models.CharField(blank=True, max_length=255, null=True, verbose_name='email verification token')),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['email'], name='users_custo_email_c80f75_idx'), models.Index(fields=['created_at'], name='users_custo_created_f4b145_idx')],
            },
            managers=[
